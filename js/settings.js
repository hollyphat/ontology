...
if(env == "local"){
    url = "http://project.apps/chat/api.php";
    base_url = "http://project.apps/chat";
    server_upload_url = "http://project.apps/cdn/";

}else{
    base_url = "https://projects.onlinemedia.com.ng/chat";
    url = 'https://projects.onlinemedia.com.ng/chat/api.php';
